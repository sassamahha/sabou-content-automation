...
# ────────────────────────── アイキャッチ画像 ID プール
MEDIA_IDS = [1942, 1949, 1946, 1929, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 2000, 2001, 2002, 2004, 2005, 2006, 2008, 2007, 2009, 2010, 2011, 2012, 2013, 2014, 2015 ]  # ←自サイトのメディア ID に置換
